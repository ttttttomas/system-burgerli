...
export default function OrderPages() {
  ...
  const filteredData = (data: Orders[]) => {
    return data.filter(
      (item) =>
        item.local.toLowerCase() === session?.local.toLowerCase() &&
  ...
  if (loading) {
    return (
      <div className="mr-8 ml-80 flex flex-col justify-start gap-5 text-black">
        Loading...
      </div>
    );
  }
  ...
  return (
    <main className="mr-8 ml-80 flex flex-col justify-start gap-5 text-black">
      ...
      <h1 className="pt-5 text-2xl font-bold">
        Historial de pedidos - {session?.local}
      </h1>
                    ...
                    >
                      <ul className="flex  gap-1">
                        ...
                        <div className="flex flex-col">
                          <li className="font-bold text-wrap max-w-50">
                            {product.name}
                          </li>
                          {product.size && (
